...
| 2026-04-25 | self | `setCloudBin` from jsonbin.js shadowed React state setter of same name in App.jsx | Import jsonbin setter as `saveCloudBin`; always call both `saveCloudBin()` (localStorage) and `setCloudBin()` (React) together |
